...
title: "Privacy"
description: ""
access_date: 2026-08-17T15:58:01.595Z
current_date: 2026-08-17T15:58:01.595Z
---
...
It is recommended to add the [`schema/snapshot`](feature-flags.md#auto-solve-merge-conflicts) feature-flag along with the `privacy` flag to enhance the development experience, for example:
...
> **Info:**
> 
> You should notice that similar to [schema hooks](hooks.md#hooks-registration), if you use the **`Policy`** option in your schema, you **MUST** add the following import in the main package, because a circular import is possible between the schema package, and the generated ent package:
> 
> ```markdown
...
> **Note:**
> 
> The privacy filtering option needs to be enabled using the [`entql`](feature-flags.md#entql-filtering) feature-flag (see instructions [above](#configuration)).
