---
url: https://entgo.io/docs/extensions
title: "Extensions"
description: ""
...
- **[entgql](https://github.com/ent/contrib/tree/master/entgql)**  
	...
	Follow [this tutorial](tutorial-todo-gql.md) to get started.
- **[entproto](https://github.com/ent/contrib/tree/master/entproto)**  
	...
	To learn how to use and set up `entproto`, read [this tutorial](grpc-intro.md). For more background you can read [this blog post](https://entgo.io/blog/2021/03/18/generating-a-grpc-server-with-ent), or [this blog post](https://entgo.io/blog/2021/06/28/gprc-ready-for-use/) discussing more `entproto` features.
...
- **[entviz (discontinued)](https://github.com/hedwigz/entviz)**  
	...
	Learn how to integrate `entviz` in your project in [this blog post](https://entgo.io/blog/2021/08/26/visualizing-your-data-graph-using-entviz). **This extension has been archived by the maintainer as of 2023-09-16**.
