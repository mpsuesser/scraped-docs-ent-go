...
3\. Lastly, we create a simple `atlas.hcl` config file with a `composite_schema` that includes both our Ent schema and the custom triggers defined in `schema.sql`:
